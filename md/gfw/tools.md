...
## Windows  
### V2rayN
<img width="160px" style="border-radius: 70%" bor src="https://xdeandtom.vercel.app/tools/images/v2rayn.png"> </img>  
Github原地址:[2dust/v2rayN](https://github.com/2dust/v2rayN)  
需要安装[.NET Framework 4.8](https://docs.microsoft.com/zh-cn/dotnet/framework/install/guide-for-developers)及以上版本  
高速下载V2rayN  
最新版本:4.20  
[日本](https://download.fastgit.org/2dust/v2rayN/releases/download/4.20/v2rayN-Core.zip) 
